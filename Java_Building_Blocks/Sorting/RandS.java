...
public class RandS
{
	public static <T extends Comparable<? super T>> void randSort(T[] array, int n)
	{
		randSort(array, 0, n-1);
	} // end quickSort

	public static <T extends Comparable<? super T>> void randSort(T[] array, int first, int last)
	{
		if (first < last)
		{
			...
			randSort(array, first, pivotIndex-1);
			randSort(array, pivotIndex+1, last);
		} // end if
	}  // end quickSort
