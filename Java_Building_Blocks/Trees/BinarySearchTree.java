...
/**
   ...
   @version 4.0
*/
public class BinarySearchTree<T extends Comparable<? super T>> extends ComparableBinaryTree<T> 
   ...
   private BinaryNode<T> removeLargest(BinaryNode<T> rootNode)
   {
	...
	public T getMin() {
		...
		if(root.getLeftChild() == null){
			...
			return new BinarySearchTree<T>(root.getLeftChild().getData()).getMin();
