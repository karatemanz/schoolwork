...
public class LinearProbingHashST<Key, Value> implements STInterface<Key, Value> {
    ...
    private int probes;		 // store probes over operations
    private int time;		 // store time over operations
    ...
    public LinearProbingHashST(int capacity, boolean o) {
    ...
    private void resize(int capacity) {
        ...
        LinearProbingHashST<Key, Value> temp = new LinearProbingHashST<Key, Value>(capacity, resize);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
